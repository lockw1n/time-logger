...
type Service interface {
	...
	Update(ctx context.Context, id uint64, req consultantdto.Request) (*consultantdto.Response, error)
	Delete(id uint64) error

	Get(ctx context.Context, id uint64) (*consultantdto.Response, error)
