...
## Command-line client (`tl`)

A terminal client for logging time and viewing your timesheet lives in
[`backend/`](backend/README.md) — see that README for install, first-run setup,
